...
import banner from '../assets/images/bg-banner-2.png';
import '../App.css';
import '../Main.css';
  ...
  return (
    <div className="App">
        ...
        <div
            ...
            style={{ marginTop: '-1em', color: 'white', backgroundImage: 'url("assets/images/bg-banner-2.png")' }}
            >
            <div className="container">
                <h1 className="text-6xl text-black-800 font-medium mb-4 capitalize">
                Apple <br /> iPhone 15 Pro
                </h1>
                <p>
