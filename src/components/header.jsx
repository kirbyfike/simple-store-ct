...
function Header() {
    ...
    <div className="App">
        {(sessionStorage.getItem('customerExperienceMode') === 'on') &&
            <header className="py-4 shadow-sm bg-slate-200 text-center">
                <p>Telco Experience Preview Mode: On</p>
            </header>
        }
        <header className="py-4 shadow-sm bg-white">
            ...
            <div className="container flex">
                ...
                <div className="flex items-center space-x-6 capitalize">
                    ...
                    <Link to={`/mo/myOffers`} className='text-gray-200 hover:text-white transition'>                    
                    My Offers
                    </Link>

                    <Link to={`/c/consumerBundles`} className='text-gray-200 hover:text-white transition'>                    
                    Bundles
                    </Link>
